...
// } Driver Code Ends
 ...
 class Solution {
    ...
    for (int i = n - 1; i >= 0; i--) 
    {
      ...
      solve(path.get(i), k - n + i + 1, result, blockNode);
    }
  ...
  public static void solve(Node root, int k, ArrayList < Integer > result, Node blockNode) 
  {
    ...
    solve(root.left, k - 1, result, blockNode);
    solve(root.right, k - 1, result, blockNode);
  }
